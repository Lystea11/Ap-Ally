...
const stats = [
  { label: "Avg. Score Gain (self-reported)*", value: "1.2 pts", icon: TrendingUp },
  { label: "Students Helped", value: "10,000+", icon: Users },
  { label: "Practice Questions", value: "50,000+", icon: BookOpen },
  { label: "User Success Rate (self-reported)*", value: "94%", icon: Star }
];
        ...
        <div className="container max-w-7xl">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-12 px-2">
            ...
            <Badge variant="outline" className="bg-background/80 backdrop-blur text-xs sm:text-sm">
              ...
              Students report avg. 1.2 point score gains*
            </Badge>
            <Badge variant="outline" className="bg-background/80 backdrop-blur text-xs sm:text-sm">
          ...
          <p className="mt-4 text-xs text-foreground/40 max-w-2xl mx-auto px-2">
            * Based on self-reported outcomes from AP Ally users. Individual results vary and depend on effort, study habits, and other factors. AP Ally does not guarantee specific exam scores or outcomes.
          </p>
        </div>
      </section>
