...
export function DynamicBackground() {
    return (
      <div className="absolute top-0 z-[-2] h-screen w-screen bg-background">
        <div className="absolute inset-0 h-full w-full bg-white bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:2rem_2rem]"></div>
